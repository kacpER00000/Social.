...
public class CloudinaryController {
    ...
    public ResponseEntity<CloudinaryDTO> getSignature() {
        ...
        return ResponseEntity.ok(new CloudinaryDTO(cloudinary.apiSignRequest(paramsToSign, cloudinary.config.apiSecret,
                SignatureAlgorithm.SHA256.ordinal()), timestamp));
    }
